...
const NAV_LINKS = [
  ...
  { href: "/build", label: "Element Builder", code: "03", desc: "Custom construction" },
  { href: "/lore", label: "Setting & Lore", code: "04", desc: "The world of Hardwar" },
  { href: "/session", label: "Session Aid", code: "05", desc: "Solo/Co-op engine" },
];
